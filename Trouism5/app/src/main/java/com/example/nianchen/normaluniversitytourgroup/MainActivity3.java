    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent();
                i.setClass(MainActivity3.this, GroupActivity.class);
                startActivity(i);
            }
        });
        tv3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="http://123.207.228.232:8080/blog/Fabucontent";
                ...
                client.get(url, rp, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int i, Header[] headers, byte[] bytes) {
                        ...
                        i1.setClass(MainActivity3.this, GroupActivity.class);
                        startActivity(i1);
                        Toast.makeText(MainActivity3.this, "发布成功", Toast.LENGTH_SHORT).show();
                    }
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id)
            {
                if( imageItem.size() == 10) { //第一张为默认图片
                    Toast.makeText(MainActivity3.this, "图片数9张已满", Toast.LENGTH_SHORT).show();
                }
                else if(position == 0) { //点击图片位置为+ 0对应0张图片
                    Toast.makeText(MainActivity3.this, "添加图片", Toast.LENGTH_SHORT).show();
                    //选择图片
