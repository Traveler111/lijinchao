...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton mBtnMes;
    private ImageButton mBtnAtt;//景点
    ...
    private void getViews(){
        ...
        mBtnMy = (ImageButton) findViewById(R.id.btn_my);
        mBtnMes = (ImageButton) findViewById(R.id.btn_mes);
        mBtnAtt = (ImageButton) findViewById(R.id.btn_attractions);
